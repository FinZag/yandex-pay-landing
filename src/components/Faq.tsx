...
const items = [
  {
    ...
    a: (
      <>
        Скачивание и установка бесплатны — играть можно без вложений. Внутри есть реклама и
        необязательные покупки: они ускоряют прогресс или отключают рекламу, но никакой контент за
        ними не заперт. Подписок нет.
      </>
    ),
  },
  {
  ...
  {
    id: 'inapp',
    q: 'Чем взнос на сайте отличается от покупок внутри игры?',
    a: (
      <>
        Это разные вещи. Покупки внутри игры проводит магазин RuStore по своим правилам — сайт в них
        не участвует. Взнос на сайте — добровольная поддержка разработки через Яндекс Пэй, он не
        даёт никаких игровых бонусов.
      </>
    ),
  },
  {
